...
g2 = Game.create!(date: "2015-11-13", time: "8:00", home_team: t2, away_team: t3, home_goals: 1, away_goals: 3)
g3 = Game.create!(date: "2015-11-14", time: "7:30", home_team: t4, away_team: t3, home_goals: 5, away_goals: 10)
g4 = Game.create!(date: "2015-11-20", time: "7:30", home_team: t2, away_team: t1, home_goals: 15, away_goals: 6)
g5 = Game.create!(date: "2015-12-01", time: "7:40", home_team: t1, away_team: t4, home_goals: 9, away_goals: 4)
